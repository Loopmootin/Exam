...
<html>
	...
	<div class="col-1-1 contentContainer">
		<div class="col-2-3 result">
			<div class="col-1-4 candidatePicture">
				<img src="img/benedikte_kiaer.jpg" alt="billedeAfBenedikteKiaer" class="candidateMatch">
			</div> 
			<div class="col-9-12 candidateInfo">
				<h1>Woop! Du har mest til fælles med:</h1>
			...
			<div class="col-1-1 tryAgain">
				<form action="index.php">
					<input type="submit" name="next" value="Prøv Igen" class="resultButton button">
				</form>
			</div>
		</div>
	</div>
